 ...
 *
 * They are used by the [SgfNodeHandler] and understood by the [DefaultSgfDrawer]. You might of course
...
object SgfInfoKeys {
    ...
    /** Strings used by [DefaultSgfDrawer] to display the [SgfProperty.PL] property */
    @Status.Beta
    ...
    /** Strings used by [DefaultSgfDrawer] to display the [SgfProperty.DM] property */
    @Status.Beta
    public var DM: Map<SgfType.Double.Value, String> = getMap(fDM)

    /** Strings used by [DefaultSgfDrawer] to display the [SgfProperty.GB] property */
    @Status.Beta
    public var GB: Map<SgfType.Double.Value, String> = getMap(fGB)

    /** Strings used by [DefaultSgfDrawer] to display the [SgfProperty.GW] property */
    @Status.Beta
    public var GW: Map<SgfType.Double.Value, String> = getMap(fGW)

    /** Strings used by [DefaultSgfDrawer] to display the [SgfProperty.HO] property */
    @Status.Beta
    public var HO: Map<SgfType.Double.Value, String> = getMap(fHO)

    /** Strings used by [DefaultSgfDrawer] to display the [SgfProperty.UC] property */
    @Status.Beta
    public var UC: Map<SgfType.Double.Value, String> = getMap(fUC)

    /** Strings used by [DefaultSgfDrawer] to display the [SgfProperty.BM] property */
    @Status.Beta
    public var BM: Map<SgfType.Double.Value, String> = getMap(fBM)

    /** Strings used by [DefaultSgfDrawer] to display the [SgfProperty.TE] property */
    @Status.Beta
    public var TE: Map<SgfType.Double.Value, String> = getMap(fTE)

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.C] property */
    @Status.Beta
    public var C: String = ""

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.GC] property */
    @Status.Beta
    public var GC: String = "Game info"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.N] property */
    @Status.Beta
    public var N: String = "Node"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.V] property */
    @Status.Beta
    public var V: String = "Score"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.DO] property */
    @Status.Beta
    public var DO: String = "doubtful move"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.IT] property */
    @Status.Beta
    public var IT: String = "interesting move"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.AN] property */
    @Status.Beta
    public var AN: String = "Annotations by"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.BR] property */
    @Status.Beta
    public var BR: String = "Black player rank"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.BT] property */
    @Status.Beta
    public var BT: String = "Black team"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.CP] property */
    @Status.Beta
    public var CP: String = "Copyright"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.DT] property */
    @Status.Beta
    public var DT: String = "Date of game"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.EV] property */
    @Status.Beta
    public var EV: String = "Event"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.GN] property */
    @Status.Beta
    public var GN: String = "Game"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.ON] property */
    @Status.Beta
    public var ON: String = "Opening"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.OT] property */
    @Status.Beta
    public var OT: String = "Byo-yomi"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.PB] property */
    @Status.Beta
    public var PB: String = "Black player"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.PC] property */
    @Status.Beta
    public var PC: String = "Place"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.PW] property */
    @Status.Beta
    public var PW: String = "White player"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.RE] property */
    @Status.Beta
    public var RE: String = "Result"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.RO] property */
    @Status.Beta
    public var RO: String = "Round"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.RU] property */
    @Status.Beta
    public var RU: String = "Rule set"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.SO] property */
    @Status.Beta
    public var SO: String = "Source"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.TM] property */
    @Status.Beta
    public var TM: String = "Time limits"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.US] property */
    @Status.Beta
    public var US: String = "Game entered by"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.WR] property */
    @Status.Beta
    public var WR: String = "White player rank"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.WT] property */
    @Status.Beta
    public var WT: String = "White team"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.BL] property */
    @Status.Beta
    public var BL: String = "Time left for black/s"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.OB] property */
    @Status.Beta
    public var OB: String = "Moves left for black"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.OW] property */
    @Status.Beta
    public var OW: String = "Moves left for white"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.WL] property */
    @Status.Beta
    public var WL: String = "Time left for white/s"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.HA] property */
    @Status.Beta
    public var HA: String = "Handicap"

    /** String used by [DefaultSgfDrawer] to display the [SgfProperty.KM] property */
    @Status.Beta
    public var KM: String = "Komi"

    /** String used by [DefaultSgfDrawer] to display the application name part of the [SgfProperty.AP] property */
    @Status.Beta
