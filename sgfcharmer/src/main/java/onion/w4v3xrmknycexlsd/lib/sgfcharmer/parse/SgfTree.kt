...
import onion.w4v3xrmknycexlsd.lib.sgfcharmer.parse.SgfType.Number
import onion.w4v3xrmknycexlsd.lib.sgfcharmer.parse.SgfType.List
import onion.w4v3xrmknycexlsd.lib.sgfcharmer.parse.SgfType.Double
import onion.w4v3xrmknycexlsd.lib.sgfcharmer.parse.SgfType.Color
...
@Util
operator fun Color.Value?.not(): Color.Value? = when (this) {
